class Alabama {//used for page 2
  ...
  int inAlab(int i) {//inmate cases part 1
    int x = int(map(i, 0, a.size(), 60, 935));//map x coordinate to graph dimensions
    return(x);//return x coordinate to be plotted and used for line graph
  }


  int inAlab2(int i) {//inmate cases part 2
  ...
  int ofAlab(int i) {//officer cases part 1
    int x = int(map(i, 0, a.size(), 60, 935));//map x coordinate to graph dimensions
    return(x);//return x coordinate to be plotted and used for line graph
  }


  int ofAlab2(int i) {//officer cases part 2
